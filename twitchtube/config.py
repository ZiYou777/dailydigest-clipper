...
DATA = ["c tarik", "c VALORANT", "g Valorant"]
BLACKLIST = [
    "c ludwig",
...
# twitch
CLIENT_ID = "kdsl5g6bhzmgfiklrpjf35ill7efvl"  # Twitch Client ID
OAUTH_TOKEN = "3hcqgv5ue5vm7x5n91narikcg1100x"  # Twitch OAuth Token
...
# selenium
ROOT_PROFILE_PATH = r"C:\Users\Magic\AppData\Roaming\Mozilla\Firefox\Profiles\q8alhy0m.selenium"  # Path to the Firefox profile where you are logged into YouTube
...
FILE_NAME = "rendered_"  # Name of the rendered video
ENABLE_INTRO = True  # Enable (True/False)
RESIZE_INTRO = False  # Resize (True/False) read RESIZE_CLIPS
...
# youtube
TITLE = "StreamerDigest **GAMING** (Daily!)"  # youtube title, leave empty for the first clip's title
DESCRIPTION = (
